...
int main(int argc, char* argv[])
{
  ...
  while(ros::ok()) {
	...
	ros::spinOnce();
      ...
      //usleep(2500*1000);                                                           robot.setState(WP3_STATE);
      break;
    ...
    case WP3_STATE: {
      ...
      robot.findAction();
      if(robot.getRecogStopResult() == true)
	robot.setState(GOAL_STATE);
      else robot.setState(FOLLOW_STATE);
      break;
    }
    case FOLLOW_STATE: {
