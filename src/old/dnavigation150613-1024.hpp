...
#define SPEAK_SAY_OPEN "padsp ~/myprog/src/music/bin/music ~/myprog/src/voice/english/sayopen.wav"
...
public:
  ...
  void   prepWindow();
  void   readTemplate();
  void   recognPizeVoice(const string str);
